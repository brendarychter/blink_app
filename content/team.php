        ...
        <div class="container" style="padding-top:35px">
            <div class="row" style="padding:35px">
                <div class="col-sm-12 col-md-4 col-lg-4 team-member">
                    ...
                    <p class="text-muted profession">Project Manager</p>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 team-member">
                    ...
                    <h4>Juan Mar&iacute;a Migliore</h4>
                    <p class="text-muted profession">Front and Back End Developer</p>
                    <div class="separator">·</div>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 team-member">
                    ...
                    <h4>Germ&aacute;n Figueroa</h4>
                    <p class="text-muted profession">UI &#38; UX designer</p>
                    <div class="separator">·</div>
