    ...
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
             ...
             <!-- href="#page-top"-->
            <a class="navbar-brand page-scroll" href="../index" style="margin-top: -4px; padding: 0;"><img alt="Blink App" title="Blink App" src="../public/img/logo.svg" class="img_menu" id="icon-top"></img></a>
